...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['role:super-admin,admin,bendahara,keuangan'])->group(function () {
        ...
        Route::post('/keuangan/tagihan/{tagihan}/gateway', [KeuanganController::class, 'createGatewayTransaksi'])->middleware('action:action.create')->name('keuangan.tagihan.gateway');
